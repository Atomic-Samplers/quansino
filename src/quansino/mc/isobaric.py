...
class Isobaric(Canonical[MoveType, CriteriaType], Generic[MoveType, CriteriaType]):
    """
    Isobaric (NPT) Monte Carlo simulation object for performing NPT simulations.

    This class is a subclass of the [`Canonical`][quansino.mc.canonical.Canonical] class and
