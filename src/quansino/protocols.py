...
class Move(Serializable, Protocol, Generic[ContextType]):
    ...
    def __call__(self, context: ContextType) -> bool:
        ...
        valid configuration, and should typically involve geometric (regions, distances
        between atoms, ...) constraints. Energy constraints should not be used here, as
        they are typically handled by [`Criteria`][quansino.protocols.Criteria] classes.
